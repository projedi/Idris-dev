...
expandParamsD rhsonly ist dec ps ns (PClauses fc opts n cs)
  ...
  where
    expandParamsC (PAutoProveClause c) = PAutoProveClause (expandParamsC' c)
    expandParamsC (PProveClause prf c) = PProveClause (expandParams dec ps ns [] prf) (expandParamsC' c)
