...
--                     when (not pattern) $
    ...
    elab' ina@ElabCtxt{e_inarg = False} mfc (PRewrite fc substfn rule sc newg)
        = elabRewrite (elab' ina mfc) ist fc substfn rule sc newg
    elab' ina@ElabCtxt{e_inarg = True} mfc (PRewrite fc substfn rule sc newg)
        = elabRewriteInPattern (elab' ina mfc) ist fc substfn rule sc newg
